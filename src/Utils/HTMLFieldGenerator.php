...
class HTMLFieldGenerator
{
	...
	switch ($field->htmlType)
	{
		...
		$fieldTemplate	 = str_replace(
			'$INPUT_ARR$', GeneratorFieldsInputUtil::prepareKeyValueArrayStr($radioLabels), $fieldTemplate
		);
		break;
	    case 'checkbox':
	...
	$fieldTemplate = str_replace('$REQUIRED$', !empty($field->validations), $fieldTemplate);
