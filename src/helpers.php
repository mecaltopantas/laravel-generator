...
if (!function_exists('get_template_file_path'))
{
	...
	$templatesPath = config(
		'infyom.laravel_generator.path.templates_dir', base_path('resources/infyom/infyom-generator-templates/')
	);
	...
	return base_path('vendor/marifetler/' . $templateType . '/templates/' . $templateName . '.stub');
    }
...
if (!function_exists('urlFilterColumn'))
{
     ...
     * @return string
     */
    function urlFilterColumn($key, $type, $value = '', $singleSorting = true)
    {
